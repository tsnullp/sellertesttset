...
const start = async ({  userID, loginID, password }) => {
  ...
  try {
    ...
    await page.tap(".join > li:nth-child(2)")
    const newPage = await newPagePromise; 
    await newPage.tap("#id")
    await newPage.type("#id", loginID.split("@")[0], opts)
    await newPage.tap("#pw")
    await newPage.type("#pw", password, opts)
    await newPage.tap(".btn_login")
    ...
    await page.goto("https://www.tabae.co.kr/Front/Acting/Order_L.asp?gMnu1=206&gMnu2=20601&sGo=1&sReqDvsCd=&sStateSeq=&sSvcDvsCd=&sBeginDt=&sEndDt=&sCtmsSameYn=&sFreightIvcYn=&sOrderNo=&sTrkNo=&sConsNmKr=&sProNm=&sProNo=&sIvcNo=&sMarketNm=&sMarketOrderNo=&sShopOrderNo=", {
