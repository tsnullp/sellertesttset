  ...
  Mutation: {
    ...
    ModifyWeightPrice: async (
      ...
      try {
        ...
        const salePrice = product.options
        ...
        if(getExceptCatetory(product.coupang.displayCategoryCode)) {
          // 카테고리 예외
        ...
        product.deliveryChargeOnReturn = returnCharge
        product.returnCharge = returnCharge
        let coupangProductResponse = await CoupnagUpdateProduct({
          userID: user,
          product:product.product
        })
