...
import { CoupangStoreItem } from "components"
import { useQuery, useMutation } from "@apollo/client"
import { GET_COUPANG_STORE_ITEM_LIST,  GET_COUPANG_KEYWORD_ITEM_LIST, GET_COUPANG_MALL_LIST, SET_COUPANG_FAVORITE, GET_COUPANG_MALL_FAVORITE_LIST, UPLOAD_ITEM_COUPANG_LIST, GET_SUBPRICE, GET_SHIPPINGPRICE } from "gql"
...
const CoupangStorePage = () => {
  ...
  const [uploadWinner] = useMutation(UPLOAD_ITEM_COUPANG_LIST)
  ...
  const handleUpload = async() => {
    ...
    if(response.data.UploadItemCoupangList){
    ...
    <RootContainer>
      ...
      <Container>
        ...
        <CoupangStoreItemContainer>
          <CoupangStoreItem count={count} list={list} loading={loading} ref={childRef} subPrice={subPrice} shippingPrice={shippingPrice}/>
        </CoupangStoreItemContainer>
      </Container>
...
export default CoupangStorePage
