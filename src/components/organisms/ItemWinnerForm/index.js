...
import { TAOBAO_IMAGE_LIST_URL, UPLOAD_ITEM_WINNER, GET_SUBPRICE } from "../../../gql"
import { useMutation } from "@apollo/client"
import StartRatings from "react-star-ratings"

const { shell } = window.require("electron")

const ItemWinnerForm = ({ item, nextButtonClick, urlSearch }) => {
  ...
  const [uploadItem] = useMutation(UPLOAD_ITEM_WINNER)
  const urlRef = useRef()
      ...
      <Container>
        <CoupangWrapper>
          <Modal
            ...
            onOk={() => {
              if (urlRef.current.state.value.includes("coupang.com")) {
